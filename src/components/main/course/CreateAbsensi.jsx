        ...
        <ContainerModal>
            <div className="max-h-[90vh] md:w-[800px] w-full overflow-y-auto grid md:grid-cols-3 grid-cols-2 gap-1">
                ...
                >
                    ...
                    <div className={`${style.input} w-full grid grid-cols-3`}>
                        <div className="flex justify-start gap-2 items-center ">
                            ...
                            <input type="checkbox" value={"gps"} id="gps" onChange={handleChangeOpsiAbsensi} />
                        </div>
                        <div className="flex justify-start gap-2 items-center ">
                            <label htmlFor="qrcode">QR Code</label>
                            <input type="checkbox" value={"qrcode"} id="qrcode" onChange={handleChangeOpsiAbsensi} />
                        </div>
                        <div className="flex justify-start gap-2 items-center ">
                            <label htmlFor="token">Token</label>
                            <input type="checkbox" value={"token"} id="token" onChange={handleChangeOpsiAbsensi} />
                        </div>
                    </div>
                    {opsiAbsensi.includes("gps") && (
                        <div className="w-full">
                    ...
                    {opsiAbsensi.includes("token") && (
                        <div className="w-full">
                            ...
                            <input
                                ...
                                ref={tokenRef}
                            />
                            <div className="text-blue1 w-max text-xs font-sans font-semibold cursor-pointer hover:underline" onClick={handleGenereteRandomCode}>Generate Random Code ?</div>
                        </div>
                    )}
                ...
                <div className="flex md:col-span-1 col-span-2 px-2 border-blue1 border rounded-md justify-center items-center flex-col">
                    ...
                    {opsiAbsensi.includes("qrcode") && <GenerateQRCode value="jamalsarah" />}
                </div>
