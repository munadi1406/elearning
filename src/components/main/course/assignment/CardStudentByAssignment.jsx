...
import { insertNilai } from "../../../../api/tugas";
...
export default function CardStudentByAssignment({
  ...
  return (
    ...
    >
      ...
      >
        <ScaleEffectMotion>
          <div className="text-white text-xs rounded-md cursor-pointer bg-blue1 px-2 py-1 w-max flex gap-2 justify-center items-center" onClick={()=>handleClickFile(file)}>
